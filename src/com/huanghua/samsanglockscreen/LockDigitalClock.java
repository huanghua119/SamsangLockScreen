 ...
 * Displays the time
 */
public class LockDigitalClock extends RelativeLayout {
    ...
    private static class TimeChangedReceiver extends BroadcastReceiver {
        private WeakReference<LockDigitalClock> mClock;
        private Context mContext;

        public TimeChangedReceiver(LockDigitalClock clock) {
            mClock = new WeakReference<LockDigitalClock>(clock);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final LockDigitalClock clock = mClock.get();
            if (clock != null) {
    ...
    private static class FormatChangeObserver extends ContentObserver {
        ...
        public FormatChangeObserver(LockDigitalClock clock) {
            super(new Handler());
            mClock = new WeakReference<LockDigitalClock>(clock);
            mContext = clock.getContext();
        }
        ...
        public void onChange(boolean selfChange) {
            LockDigitalClock digitalClock = mClock.get();
    ...
    public LockDigitalClock(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    protected void onFinishInflate() {
        ...
        /*
         * The time display consists of two tones. That's why we have two
         * overlapping text views.
         */
